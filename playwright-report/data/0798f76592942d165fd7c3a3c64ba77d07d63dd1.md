...
- Name: auth.spec.ts >> Authentication & Security Controls Suite >> should reject invalid email format without @ symbol
- Location: e2e\auth.spec.ts:40:7
...
Expected pattern: /valid email/i
Received string:  ""
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('alert')
    13 × locator resolved to <div role="alert" aria-live="assertive" id="__next-route-announcer__"></div>
       - unexpected value ""
