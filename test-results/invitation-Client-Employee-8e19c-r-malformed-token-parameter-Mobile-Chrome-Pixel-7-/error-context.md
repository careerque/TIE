...
- Name: invitation.spec.ts >> Client & Employee Invitation Verification System >> should safely render error or alert for malformed token parameter
- Location: e2e\invitation.spec.ts:9:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/accept-invite?token=malformed-123-%20-injection
Call log:
  - navigating to "http://localhost:3000/accept-invite?token=malformed-123-%20-injection", waiting until "domcontentloaded"
