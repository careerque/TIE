...
Received string:  "http://localhost:3000/manager"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    13 × locator resolved to <html lang="en" class="__variable_fa2f99">…</html>
       - unexpected value "http://localhost:3000/manager"
...
- navigation:
  ...
  - link "Sign In":
    - /url: /login
- main:
  - main: Redirecting to dynamic Manager dashboard...
- contentinfo:
  - text: TIE • Insights
