...
- Name: security.spec.ts >> Security, Edge Cases & Route Protection Suite >> should safely handle malformed tenant slug routes without crashing
- Location: e2e\security.spec.ts:46:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/%3Cscript%3Ealert(1)%3C/script%3E/%3Cinvalid%3E/user
Call log:
  - navigating to "http://localhost:3000/%3Cscript%3Ealert(1)%3C/script%3E/%3Cinvalid%3E/user", waiting until "domcontentloaded"
