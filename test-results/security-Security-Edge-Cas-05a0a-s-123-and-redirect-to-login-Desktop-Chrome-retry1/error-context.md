...
Received string:  "http://localhost:3000/reports/123"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    11 × locator resolved to <html lang="en" class="__variable_fa2f99">…</html>
       - unexpected value "http://localhost:3000/reports/123"
...
- navigation:
  ...
  - link "Sign In":
    - /url: /login
- main:
  - heading "Loading Employee Behavioral Report..." [level=2]
  - paragraph: Retrieving assessment metrics & WBIL intelligence
- contentinfo:
  - text: TIE • Insights
