...
- Name: security.spec.ts >> Security, Edge Cases & Route Protection Suite >> should safely handle SQL injection string in query params
- Location: e2e\security.spec.ts:51:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/login?redirect=1%27%20OR%20%271%27=%271
Call log:
  - navigating to "http://localhost:3000/login?redirect=1%27%20OR%20%271%27=%271", waiting until "domcontentloaded"
