...
export default function RegisterPage() {
  ...
  if (success) return (
    <main style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', padding:'1.5rem', background:'linear-gradient(135deg,#eef2f7 0%,#F4F7FA 55%,#e8edf4 100%)', fontFamily:"'Inter',system-ui,sans-serif" }}>
      ...
      <style>{`@keyframes cardIn { from { opacity:0; transform:translateY(22px) scale(0.985); } to { opacity:1; transform:none; } }`}</style>
    </main>
  );
        ...
        <div style={{ padding: '2.25rem 2.5rem 2.5rem' }}>
          ...
          {error && (
            <div role="alert" style={{
              ...
              background:'rgba(220,53,69,0.06)', border:'1px solid rgba(220,53,69,0.18)',
              borderRadius:'10px', color:'#c0392b', fontSize:'0.8375rem', fontWeight:500,
          ...
          <form onSubmit={handleSubmit} noValidate style={{ display:'flex', flexDirection:'column', gap:'1.1rem', animation:'fadeUp .5s .20s both' }}>
            ...
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'0.75rem' }}>
              ...
              {/* First Name */}
              <div>
                <label htmlFor="firstName" style={{ display:'block', fontSize:'0.8125rem', fontWeight:600, color:'#243B53', marginBottom:'0.4rem' }}>
                  First Name
                </label>
              ...
              {/* Last Name */}
              <div>
                <label htmlFor="lastName" style={{ display:'block', fontSize:'0.8125rem', fontWeight:600, color:'#243B53', marginBottom:'0.4rem' }}>
                  Last Name
                </label>
                <div style={{ position:'relative' }}>
                  <span style={{ position:'absolute', left:'13px', top:'50%', transform:'translateY(-50%)', display:'flex', alignItems:'center', pointerEvents:'none', zIndex:1 }}>
            ...
            <button
              ...
              disabled={loading}
              style={{
                width:'100%', padding:'0.825rem 1.5rem', marginTop:'0.25rem',
          ...
          <div style={{ display:'flex', alignItems:'center', gap:'0.75rem', margin:'1.5rem 0 1rem', animation:'fadeUp .5s .32s both' }}>
            ...
            <span style={{ fontSize:'0.7rem', fontWeight:600, color:'#9aa8b6', letterSpacing:'0.07em', textTransform:'uppercase' }}>Secure Sign Up</span>
            <div style={{ flex:1, height:'1px', background:'rgba(36,59,83,0.09)' }} />
          </div>
          ...
          <div style={{ borderTop:'1px solid rgba(36,59,83,0.08)', paddingTop:'1.375rem', textAlign:'center', animation:'fadeUp .5s .44s both' }}>
            <p style={{ fontSize:'0.875rem', color:'#627D98' }}>
              Already a user?{' '}
              <Link href="/login" style={{ color:'#5BA4A4', fontWeight:700, textDecoration:'none' }}
