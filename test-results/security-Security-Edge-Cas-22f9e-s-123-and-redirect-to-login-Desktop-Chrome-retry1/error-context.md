...
Received string:  "http://localhost:3000/action-plans/123"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    10 × locator resolved to <html lang="en" class="__variable_fa2f99">…</html>
       - unexpected value "http://localhost:3000/action-plans/123"
...
- navigation:
  ...
  - link "Sign In":
    - /url: /login
- main:
  - heading "Loading 30-Day Action Plan..." [level=2]
  - paragraph: Fetching weekly breakdown & commitments
- contentinfo:
  - text: TIE • Insights
