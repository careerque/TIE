...
- Name: security.spec.ts >> Security, Edge Cases & Route Protection Suite >> should block unauthenticated access to /hr-admin and redirect to /login
- Location: e2e\security.spec.ts:20:7
...
Received string:  "http://localhost:3000/hr-admin"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    14 × locator resolved to <html lang="en" class="__variable_fa2f99">…</html>
       - unexpected value "http://localhost:3000/hr-admin"
...
- navigation:
  ...
  - link "Sign In":
    - /url: /login
- main:
  - main: Redirecting to dynamic HR workspace...
- contentinfo:
  - text: TIE • Insights
