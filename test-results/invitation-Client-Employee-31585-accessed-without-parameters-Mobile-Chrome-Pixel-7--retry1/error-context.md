...
- Name: invitation.spec.ts >> Client & Employee Invitation Verification System >> should render accept invite page structure when accessed without parameters
- Location: e2e\invitation.spec.ts:4:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/accept-invite
Call log:
  - navigating to "http://localhost:3000/accept-invite", waiting until "domcontentloaded"
