...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/assessment
Call log:
  - navigating to "http://localhost:3000/assessment", waiting until "domcontentloaded"
