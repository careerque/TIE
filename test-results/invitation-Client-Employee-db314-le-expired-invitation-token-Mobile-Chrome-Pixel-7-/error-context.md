...
- Name: invitation.spec.ts >> Client & Employee Invitation Verification System >> should safely handle expired invitation token
- Location: e2e\invitation.spec.ts:14:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/accept-invite?token=expired-token-uuid-0000
Call log:
  - navigating to "http://localhost:3000/accept-invite?token=expired-token-uuid-0000", waiting until "domcontentloaded"
