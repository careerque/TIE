...
- Name: security.spec.ts >> Security, Edge Cases & Route Protection Suite >> should block unauthenticated access to /profile and redirect to /login
- Location: e2e\security.spec.ts:15:7
